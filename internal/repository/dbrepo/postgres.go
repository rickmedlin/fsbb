...
func (m *postgresDBRepo) GetUserByID(id int) (models.User, error) {
	...
	query := `select id, first_name, last_name, email, password, accesss_level, created_at, updated_at
...
func (m *postgresDBRepo) UpdateUser(u models.User) error {
	...
	query :=
		`update users set first_name = $1, last_name = $2, email = $3, accesss_level = $4, updated_at = $5`
...
// Authenticate checks the password entered by user to a hashed value from the user table.
...
// AllReservations returns a slice of all resrvations.
...
func (m *postgresDBRepo) AllRooms() ([]models.Room, error) {
	...
	query := `select id, room_name, created_at, updated_at from rooms order by 2`
...
func (m *postgresDBRepo) GetRestrictionsForRoomByDate(roomID int, start, end time.Time) ([]models.RoomRestriction, error) {
	...
	query := `select id, coalesce(reservation_id), restriction_id, room_id, start_date, end_date
